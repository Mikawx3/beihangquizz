      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            ...
            <button
              onClick={() => {
                const publicUrl = `/results/${sessionId}`;
                navigator.clipboard.writeText(`${window.location.origin}${publicUrl}`).then(() => {
                  alert('Lien public copié dans le presse-papiers !\n\nVous pouvez partager ce lien avec n\'importe qui.');
                }).catch(() => {
                  // Si la copie échoue, ouvrir dans un nouvel onglet
              ...
              title="Copier le lien public vers les résultats"
            >
              🔗 Copier lien public
            </button>
            <button
                ...
                {questionStats.map((stats: any, index: number) => (
                  <div
                    ...
                    style={{
                      ...
                      pageBreakInside: 'avoid' // Pour l'impression
                    }}
                  >
                    <h3 style={{
                      color: '#333',
                    ...
                    {/* Résultats selon le type de question */}
