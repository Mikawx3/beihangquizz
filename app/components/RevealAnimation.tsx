...
const AVAILABLE_SOUNDS = [
  ...
  '/sounds/Dasheng Xuanheniu Self-service Barbecue (Zhichun Road Branch) 2.mp3',
  '/sounds/Zhichun Road Side Road.mp3',
  '/sounds/Zhichun Road Side Road 2.mp3',
  '/sounds/Zhichun Road Side Road 3.mp3',
  '/sounds/Zhichun Road Side Road 4.mp3',
  '/sounds/Zhichun Road Side Road 5.mp3',
  '/sounds/Zhichun Road Side Road 6.mp3',
  '/sounds/Zhichun Road Side Road 7.mp3',
